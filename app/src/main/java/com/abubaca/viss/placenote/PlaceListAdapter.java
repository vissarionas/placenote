...
public class PlaceListAdapter extends BaseAdapter {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    if(placenotes.size()>0){
      ...
      TextView placeText = convertView.findViewById(R.id.placeText);
      TextView noteText = convertView.findViewById(R.id.noteText);
      stateIV = convertView.findViewById(R.id.stateIV);

      final ImageButton listItemMenuButton = convertView.findViewById(R.id.list_item_menu);
      LinearLayout listItemSurface = convertView.findViewById(R.id.list_item);
  ...
  private void addRemoveSelectedPlace(String place , View view){
    ImageButton menuBTN = view.findViewById(R.id.list_item_menu);
    ...
    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
      ...
      switch (item.getItemId()){
        ...
        case R.id.view_on_map:
          new ActivityStarter(activity).startViewPlaceActivity(place);
          return true;
